# ==============================================================
# Project  : DAHEJ CALCULATOR (Satirical)
...
print("=" * 70)
print("😂 WELCOME TO THE DAHEJ CALCULATOR 😂".center(70))
print("=" * 70)
...
print("=" * 65)
print("😂 WELCOME TO THE DAHEJ CALCULATOR 😂".center(65))
print("=" * 65)
...
while True:
    ...
    if greed_score <= 150:
        ...
        print("💀 Verdict : Dahej Premium Plus Ultra Max Family")
